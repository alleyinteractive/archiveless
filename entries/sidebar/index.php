 ...
 */
function wp_archiveless_register_plugin_scripts(): void {
	/**
...
add_action( 'init', 'wp_archiveless_register_plugin_scripts' );

/**
 * Enqueue styles/scripts for the sidebar entry point.
 */
function wp_archiveless_enqueue_plugin(): void {
	wp_enqueue_script( 'archiveless-sidebar-js' );
}
add_action( 'enqueue_block_assets', 'wp_archiveless_enqueue_plugin' );
